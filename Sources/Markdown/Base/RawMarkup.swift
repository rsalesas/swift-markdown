...
final class RawMarkup: ManagedBuffer<RawMarkupHeader, RawMarkup> {
    ...
    static func blankLines(count: Int, parsedRange: SourceRange?) -> RawMarkup {
        return .create(data: .blankLines(count: count), parsedRange: parsedRange, children: [])
    }
    ...
    static func trackedChange(kind: String, replaced: String, parsedRange: SourceRange?,
                              _ children: [RawMarkup]) -> RawMarkup {
        return .create(data: .trackedChange(kind: kind, replaced: replaced),
